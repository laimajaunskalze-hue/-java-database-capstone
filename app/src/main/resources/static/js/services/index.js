...
// 2. Definējam API galapunktus
const ADMIN_API = API_BASE_URL + '/admin';
const DOCTOR_API = API_BASE_URL + '/doctor/login';

// 3. Uzstādām pogu klausītājus
...
// 4. Admina pieteikšanās apstrāde
window.adminLoginHandler = async function () {
    ...
    try {
        ...
        if (response.ok) {
            ...
            localStorage.setItem("token", data.token); // Saglabājam JWT
